...
class StripeWH_Handler:
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        print('payment_intent.succeeded webhook fired')

        # This event is generated by both subscription payments and
        # non-subscription ordinary shop payments. If this event results from
        ...
        if order_set:
            ...
            # There is no order on the system. Create one from the information
            ...
            order = Order.objects.create(
                ...
                county=shipping_data.get('state', ''),
                date=datetime.now(),
    ...
    def handle_invoice_payment_failed(self, event):
        ...
        print('handler for invoice_payment.failed fired')
        customer_id = event.data.object.customer
        subscription_id = event.data.object.subscription
        user_learning_profile = UserLearningProfile.objects.get(
            stripe_customer_id=customer_id,
